...
import compiler.PropListener;
import compiler.PropVisitor;
...
public class PropParser extends Parser {
	...
	public static class PropContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(PropParser.ID, 0); }
		public TerminalNode STRING() { return getToken(PropParser.STRING, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PropListener ) ((PropListener)listener).enterProp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PropListener ) ((PropListener)listener).exitProp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PropVisitor ) return ((PropVisitor<? extends T>)visitor).visitProp(this);
			else return visitor.visitChildren(this);
		}
	}
